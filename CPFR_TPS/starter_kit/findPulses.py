...
def main():
    ...
    parser.add_argument("preD", type=float, help="Prescription dose (Gy)")
    parser.add_argument("preV", type=float, help="Prescription volume (%%)")
...
#    print("Volume:", volume)
    ...
    targetDose=dose_cgy[np.argmin(np.abs(volume-np.array([args.preV])))]
    print(int(0.5+100*args.preD/targetDose))
