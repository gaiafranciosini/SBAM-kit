...
def drawSliceROI(axes,myMap,slice,masked,color):
    ...
    #levels = [0.5,1.0,1.5]
    #contour = axes.contour(img,linewidths=0.3, linestyles='dashed',colors='red',origin='upper',extent=getExtent(myMap,slice),alpha=1)
...
def draw():
    ...
    ROIcolor=['red','cyan', 'purple', 'green', 'orange', 'purple', 'pink', 'brown', 'gray', 'blue', 'yellow']
