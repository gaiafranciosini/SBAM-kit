...
int main (int argc, char *argv[]){
  ...
  string allROINames;
    ...
    if (argc == 2 && std::string(argv[1]) == "-h") {
        std::cout << "Usage: " << argv[0] << " -Dgoal <value> -roi <filename1> <filename2> ... -dose <filename> -type <int16> or <float32> -fileLabel <value> -dir <outputdirectory> -plot or not if you want to display the DVH" << std::endl;
        return 0; 
    }
