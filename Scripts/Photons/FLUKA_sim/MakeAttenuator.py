...
def calcola_intensita_max(region_file, optiplan_file, field_id_richiesto):
    try:
        ...
        # 4. Ricerca massimo PIN per intensità
        ...
        print("="*50)
        print(f"PIN con Intensità Max:  {id_pin_max}")
        print(f"Intensità (I_max):      {intensita_i_max:.6e}")
        ...
        num_ele_per_pulse = 10e-6 / 1.6e-19
        ...
        # 8. Calcolo spessori
        mu = 0.20 * 19.3  # Valore di mu fornito
        ...
        # Larghezza cubetti (0.2 se la cella è 0.2)
        dx = dy = 0.2 
        ...
        ax.set_zlim(0, 2.1) # Un po' più di 2 per vederlo bene
