...
#define R__DICTIONARY_FILENAME Txt2RootDict
...
namespace {
  void TriggerDictionaryInitialization_Txt2RootDict_Impl() {
...
"/loc_work1/PHOTONS_FLASH/FF/routines/",
nullptr
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "Txt2RootDict dictionary forward declarations' payload"
...
#line 1 "Txt2RootDict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("Txt2RootDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_Txt2RootDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_Txt2RootDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_Txt2RootDict() {
  TriggerDictionaryInitialization_Txt2RootDict_Impl();
}
